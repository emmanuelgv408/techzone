...
const endpointSecret = process.env.STRIPE_WEBHOOK_SECRET; // Use your actual Stripe webhook secret here
...
exports.getPastOrders = async (req, res) => {
    ...
    try {
      ...
      return res.status(200).json(orders);  // Return orders to the client
    } catch (error) {
